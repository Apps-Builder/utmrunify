          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  //image: AssetImage(event.imagePath),
                  image: NetworkImage(eventData['imagePath']),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            ...
            Row(
              children: [
                const Icon(Icons.location_on,
                    color: Color.fromARGB(255, 119, 0, 50)),
                const SizedBox(width: 8),
                Text(/*event.location*/'Location: ${eventData['location'] ?? 'N/A'}'),
              ],
            ),
            const Divider(
                height: 32,
            ...
            const SizedBox(height: 8),
            const Text(
              'Date: N/A\nTime: N/A\nVenue: N/A', // You can adjust this section as needed
              style: const TextStyle(fontSize: 16),
            ),
            /*Text(
              'Date: ${event.collectDate}\n'
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            RunSelectionPage(selectedEvent: eventData)),
                  );
                },
                style: ElevatedButton.styleFrom(
                  padding:
